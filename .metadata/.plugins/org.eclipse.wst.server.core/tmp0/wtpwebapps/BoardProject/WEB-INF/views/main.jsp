...
<body>
	...
	<!-- 상단 메뉴 부분 -->
	<!-- 다른 jsp로 구성을 함으로써 편하게 c:import를 사용하여 끌어다가 쓰기만함
	     이렇게 하면 좀 더 간단하게 코드 작성이 가능함 -->
								...
								<tbody>
									<c:forEach var="obj" items="${sub_list }">
										<tr>
											...
											<th><a href='${root }board/read?&board_info_idx=${board_list[idx.index].board_info_idx }&content_idx=${obj.content_idx}'>${obj.content_subject }</a></th>
