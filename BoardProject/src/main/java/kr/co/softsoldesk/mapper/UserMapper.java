...
public interface UserMapper {
	...
	@Insert("insert into user_table values(user_seq.nextval, #{user_name}, #{user_id}, #{user_pw})")//시퀀스를 이용하여 값을 주입
	...
	UserBean getModifyUserInfo(int user_idx);//매개변수에 담아서 UserBean으로 리턴을 시킨다!
